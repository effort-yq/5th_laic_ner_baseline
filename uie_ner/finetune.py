...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--train_path", default='./train_data.json',
                        type=str, help="The path of train set.")
    parser.add_argument("-d", "--dev_path", default='./dev_data.json',
    ...
    parser.add_argument("-m", "--model", default="../predata", type=str,
