...
class UIE(ErniePreTrainedModel):
    ...
    def forward(self, input_ids: Optional[torch.Tensor] = None,
        ...
        start_logits = self.linear_start(sequence_output)   # [batch_size, seq_len, 1]
        start_logits = torch.squeeze(start_logits, -1)   # [batch_size, seq_len]
        start_prob = self.sigmoid(start_logits)     # [batch_size, seq_len]
        end_logits = self.linear_end(sequence_output)    # [batch_size, seq_len, 1]
        end_logits = torch.squeeze(end_logits, -1)    #  [batch_size, seq_len]
        end_prob = self.sigmoid(end_logits)    # [batch_size, seq_len, 1]
